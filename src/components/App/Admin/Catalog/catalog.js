                    ...
                    <tbody>
                        ...
                        {products && products.map(((product, key) =>
                            <tr key={key}>
                                ...
                                <td className="table__icons table__link-edit"><Link to={`/admin/catalog/editProduct/${product.id}`}><img src={iconEdit} alt="icon-edit"/></Link></td>
                                <td className="table__icons table__delete" onClick={() => this.deleteProduct(product)}><img src={iconCross} alt="icon-cross"/></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
