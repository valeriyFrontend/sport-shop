    ...
    if (!this.props.items.length) {
      return (
        <section className="cart">
          ...
          <Link className="cart__link-back" to="/sport-shop/products">
            Back to shop
          </Link>
        </section>
      );
      ...
      <div className="items">
          ...
          {items.map((item, index) => (
            <div className="item" key={index}>
              ...
              <span
                ...
                onClick={() => this.props.removeCartItem(item.price, item)}
              >
                &#10006;
              </span>
        ...
        {!!items.length && (
          <div className="items__footer">
            <Link to="/sport-shop/products">
              <span className="items__footer-button">Back store</span>
            </Link>
            <div className="items__footer-price">
              Total:{" "}
              <span className="items__footer-price-number">
                ${this.props.fullPrice}.00
              </span>
            </div>
